...
urlpatterns = [
    ...
    re_path(r'^consumer/(?P<pk>\d+)/update$', views.consumer_endpoint_create_update, kwargs={'model': 'Consumer'}, name='consumer_edit'),
    path('consumer/create', views.consumer_endpoint_create_update, kwargs={'model': 'Consumer'}, name='consumer_create'),
    ...
    re_path(r'^endpoint/(?P<pk>\d+)/edit$', views.consumer_endpoint_create_update, kwargs={'model': 'EndPoint'}, name='endpoint_edit'),
    path('endpoint/create', views.consumer_endpoint_create_update, kwargs={'model': 'EndPoint'}, name='endpoint_create'),
